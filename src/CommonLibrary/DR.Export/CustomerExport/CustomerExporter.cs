...
namespace DR.Export.CustomerExport {
    public class CustomerExporter : OpentXmlBaseExport {
        private readonly List<CustomerExportData> data;
        private readonly EExportFile exportFile;

        public CustomerExporter(List<CustomerExportData> data, EExportFile exportFile) : base() {
            this.data = data;
            this.exportFile = exportFile;
        }

        public static byte[] Export(List<CustomerExportData> data, EExportFile exportFile) {
            return new CustomerExporter(data, exportFile).Export();
        }
        ...
        private void CreateExportExcel(List<CustomerExportData> data, string fName) {
